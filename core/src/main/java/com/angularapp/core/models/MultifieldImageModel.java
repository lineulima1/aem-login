...
/**
 * Defines the {@code MultifieldImageModel} Sling Model used for the multifield in {@code angularapp/components/login-component} component.
 * 
 */
@ConsumerType
public interface MultifieldImageModel
