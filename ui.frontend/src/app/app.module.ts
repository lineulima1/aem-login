...
import { InputComponent } from "./components/micro/input/input.component";
import { TypographyComponent } from "./components/micro/typography/typography.component";
import { LoginComponent } from "./components/containers/login/login.component";
import { ImagemComponent } from './components/micro/imagem/imagem.component';
import { BtnComponent } from './components/micro/btn/btn.component';
...
@NgModule({
  ...
  entryComponents: [PageComponent, LoginComponent],
